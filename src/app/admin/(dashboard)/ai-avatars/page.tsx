...
function AvatarCard({ avatar, onDelete }: { avatar: { _id: Id<"ai_avatars">; name: string; imageUrl: string; description: string; gender?: "male" | "female" | "diverse"; ethnicity?: Ethnicity; country?: CountryCode; language?: string }; onDelete: () => void }) {
        ...
        <div className="bg-surface2 border border-border rounded-2xl overflow-hidden group">
            ...
            <div className="p-4 space-y-2">
                <div className="flex items-start justify-between gap-2">
                    ...
                    <button
                        onClick={onDelete}
                        className="shrink-0 text-secondary hover:text-red-400 transition-colors opacity-0 group-hover:opacity-100"
                    >
                        <Trash2 size={15} />
                    </button>
                </div>
