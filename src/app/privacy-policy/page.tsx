        ...
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1 container mx-auto px-4 md:px-6 pt-32 pb-20">
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    {apps.map(app => (
                        <Link key={app.slug} href={`/privacy-policy/${app.slug}`} className="block p-6 bg-surface border border-border rounded-xl hover:border-accent hover:bg-surface2 transition-all">
