...
export async function POST(request: NextRequest) {
  try {
    ...
    let subject = isSupport ? "New Support Request!" : "New Contact Request!";
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #333; border-bottom: 2px solid #4F46E5; padding-bottom: 10px;">
            ${isSupport ? "New Support Request" : "New Contact Request"}
          </h2>
          ...
          ? `
          <div style="margin: 20px 0;">
            <h4 style="color: #555; margin-bottom: 5px;">Interested in App:</h4>
            <p style="margin: 0; padding: 10px; background-color: #f5f5f5; border-radius: 5px;">
              ${app}
            </p>
          </div>
          ...
          <div style="margin: 20px 0;">
            <h4 style="color: #555; margin-bottom: 5px;">Message:</h4>
          ...
          <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd; color: #888; font-size: 12px;">
            <p>This message was sent via the ${isSupport ? "support form" : "contact form"} on northbyte.studio.</p>
          </div>
        </div>
      `,
    });
